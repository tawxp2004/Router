(function() {
    ...
    function Ba(a, b) {
        for (var c = xa(a.h()), d = 0; d < c.length; d++) {
            ...
            if (q(b, f)) {
                ...
                } else e = Ca(b, f), g ? (g = Ca(a, f)) ? Ba(g, e) : u(a, f, e.clone()) : u(a, f, e)
            }
        }
    }
    ...
    y.prototype.a = function(a, b) {
        if (11 == a.b || 10 == a.b) return b instanceof p ? b : this.f(a.l.prototype.h(), b);
        if (14 == a.b) return "string" === typeof b && Fa.test(b) && (a = Number(b), 0 < a) ? a : b;
        if (!a.i) return b;
        a = a.l;
        if (a === String) {
            if ("number" === typeof b) return String(b)
        } else if (a === Number && "string" === typeof b && ("Infinity" === b || "-Infinity" === b || "NaN" === b || Fa.test(b))) return Number(b);
        return b
    };
    var Fa = /^-?[0-9]+$/;
    ...
    z.prototype.b = function(a, b) {
        return this.m && 8 == a.b && "boolean" === typeof b ? b ? 1 : 0 : z.ga.b.call(this, a, b)
    };
    ...
    z.prototype.i = function(a, b) {
        ...
        for (d in b) {
            ...
            else 2 == this.j && (d = String(d).replace(/([A-Z])/g, "-$1").toLowerCase().replace(/\-/g, "_")), g = ya(c, d);
            if (g)
                if (g.f)
                    for (f = 0; f < e.length; f++) a.add(g, this.a(g, e[f]));
                else a.set(g, this.a(g, e));
            else f ? (g = a, f = Number(d), g.b[f] = e, g.a && delete g.a[f]) : this.l || ia("Failed to find field: " + d)
        }
    };
    ...
    C.prototype.h = function() {
        ...
        a || (Ga = a = Ea(C, {
            0: {
                name: "NumberFormat",
                da: "i18n.phonenumbers.NumberFormat"
            },
            1: {
                name: "pattern",
                required: !0,
    ...
    E.prototype.h = function() {
        ...
        a || (Ia = a = Ea(E, {
            0: {
                name: "PhoneMetadata",
                da: "i18n.phonenumbers.PhoneMetadata"
            },
            1: {
                name: "general_desc",
                c: 11,
    ...
    G.prototype.h = function() {
        ...
        a || (Ka = a = Ea(G, {
            0: {
                name: "PhoneNumber",
                da: "i18n.phonenumbers.PhoneNumber"
            },
            1: {
                name: "country_code",
                required: !0,
    ...
    var I = {
        ...
        Wa = /(?:.*?[A-Za-z]){3}.*/,
        Xa = /^\+([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]|[\-\.\(\)]?)*[0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]|[\-\.\(\)]?)*$/,
        Ya = /^([A-Za-z0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]+((\-)*[A-Za-z0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9])*\.)*[A-Za-z]+((\-)*[A-Za-z0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9])*\.?$/;
    ...
    function Za() {
        return ";ext=" + K("20") + "|[ \u00a0\\t,]*(?:e?xt(?:ensi(?:o\u0301?|\u00f3))?n?|\uff45?\uff58\uff54\uff4e?|\u0434\u043e\u0431|anexo)[:\\.\uff0e]?[ \u00a0\\t,-]*" + (K("20") + "#?|[ \u00a0\\t,]*(?:[x\uff58#\uff03~\uff5e]|int|\uff49\uff4e\uff54)[:\\.\uff0e]?[ \u00a0\\t,-]*") + (K("9") + "#?|[- ]+") + (K("6") + "#|[ \u00a0\\t]*(?:,{2}|;)[:\\.\uff0e]?[ \u00a0\\t,-]*") + (K("15") + "#?|[ \u00a0\\t]*(?:,)+[:\\.\uff0e]?[ \u00a0\\t,-]*") + (K("9") + "#?")
    }
    var $a = new RegExp("(?:" + Za() + ")$", "i"),
        ab = new RegExp("^[0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]{2}$|^[+\uff0b]*(?:[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e*]*[0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]){3,}[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e*A-Za-z0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]*(?:" + Za() + ")?$", "i"),
        bb = /(\$\d)/,
        cb = /\$NP/,
        db = /\$FG/,
        eb = /\$CC/,
    ...
    function rb(a) {
        ...
        var e = S(c),
            ...
            g = -1 != f;
        if ("US" == e)
            if (d = 0 == f || 1 == f || 2 == f, "BR" == e && d) d = 0 < w(a, 7).length ? qb(b, a) : "";
            else if (1 == c) {
            c = T(b, "US");
            if (d = ub(b, a)) d = P(a), d = 2 != V(b, d, c, -1);
            d = d ? N(b, a, 1) : N(b, a, 2)
        } else d = ("001" == e || ("MX" == e || "CL" == e || "UZ" == e) && d) && ub(b, a) ? N(b, a, 1) : N(b, a, 2);
    ...
    function vb(a, b, c) {
        ...
        if (!(d in H)) return e;
        if (1 == d) {
            if (null != c && H[1].includes(c.toUpperCase())) return d + " " + N(a, b, 2)
    ...
    function xb(a, b) {
        ...
        switch (r(a, 6)) {
            ...
            default:
                ...
                else b = w(b, 12), f = 0 == b.length ? null : b = b.replace("~", "");
                b = N(c, a, 2);
    ...
    function Bb(a, b, c, d) {
        var e = w(b, 2),
            f = new RegExp(r(b, 1)),
            g = w(b, 5);
        2 == c && null != d && 0 < d.length && 0 < g.length ? (b = g.replace(eb, d), e = e.replace(bb, b), a = a.replace(f, e)) : (b = w(b, 4), a = 2 == c && null != b && 0 < b.length ? a.replace(f, e.replace(bb, b)) : a.replace(f, e));
    ...
    function nb(a, b, c) {
        return q(a, 3) && 0 != r(a, 3).length ? 3 == c ? ";ext=" + r(a, 3) : q(b, 13) ? r(b, 13) + w(a, 3) : " ext. " + w(a, 3) : ""
    }
    ...
    function Eb(a, b) {
        return W(a, r(b, 1)) ? W(a, r(b, 5)) ? 4 : W(a, r(b, 4)) ? 3 : W(a, r(b, 6)) ? 5 : W(a, r(b, 8)) ? 6 : W(a, r(b, 7)) ? 7 : W(a, r(b, 21)) ? 8 : W(a, r(b, 25)) ? 9 : W(a, r(b, 28)) ? 10 : W(a, r(b, 2)) ? r(b, 18) || W(a, r(b, 3)) ? 2 : 0 : !r(b, 18) && W(a, r(b, 3)) ? 1 : -1 : -1
    }
    ...
    function V(a, b, c, d) {
        ...
        e = v(e, 10);
        if (2 == d)
            if (kb(Cb(c, 0))) a = Cb(c, 1), kb(a) && (f = f.concat(0 == x(a, 9) ? v(r(c, 1), 9) : v(a, 9)), f.sort(), 0 == e.length ? e = v(a, 10) : (e = e.concat(v(a, 10)), e.sort()));
    ...
    function Hb(a, b) {
        ...
        for (var c, d = a.length, e = 1; 3 >= e && e <= d; ++e)
            if (c = parseInt(a.substring(0, e), 10), c in H) return b.a(a.substring(e)), c;
        return 0
    }
    ...
    function Ib(a, b, c, d, e, f) {
        ...
        if (0 == h.length) g = 20;
            ...
            if (0 == g.search(h)) {
                ...
                m && null != m[1] && 0 < m[1].length && "0" == M(m[1], I) ? g = !1 : (B(b), b.a(g.substring(h)), g = !0)
            } else g = !1;
            g = g ? 5 : 20
        }
        e && u(f, 6, g);
        ...
        if (null != c && (g = w(c, 10), h = "" + g, m = b.toString(), 0 == m.lastIndexOf(h, 0) && (h = new A(m.substring(h.length)), m = r(c, 1), m = new RegExp(w(m, 2)), Jb(h, c, null), h = h.toString(), !L(m, b.toString()) && L(m, h) || 3 == V(a, b.toString(), c, -1)))) return d.a(h), e && u(f, 6, 10), u(f, 1, g), g;
        u(f, 1, 0);
        return 0
    }
        ...
        if (0 != e && null != f && 0 != f.length) {
            ...
            if (e = g.exec(d)) {
                ...
                if (null == b || 0 == b.length || null == e[m] || 0 == e[m].length) {
                    if (!h || L(f, d.substring(e[0].length))) null != c && 0 < m && null != e[m] && c.a(e[1]), a.set(d.substring(e[0].length))
    ...
    function Ab(a, b, c, d) {
        ...
        var h = f;
        null == h ? g = !0 : 0 === h.length ? g = !1 : (g = Xa.exec(h), h = Ya.exec(h), g = null !== g || null !== h);
        if (!g) throw Error("The string supplied did not seem to be a phone number");
        null != f ? ("+" === f.charAt(0) && e.a(f), f = b.indexOf("tel:"), e.a(b.substring(0 <= f ? f + 4 : 0, b.indexOf(";phone-context=")))) : e.a(gb(null != b ? b : ""));
        f = e.toString();
        g = f.indexOf(";isub=");
        0 < g && (B(e), e.a(f.substring(0, g)));
        if (!hb(e.toString())) throw Error("The string supplied did not seem to be a phone number");
        f = e.toString();
        if (!(mb(c) || null != f && 0 < f.length && J.test(f))) throw Error("Invalid country calling code");
        f = new G;
        d && u(f, 5, b);
        a: {
            b = e.toString();g = b.search($a);
        ...
        try {
            ...
            if ("Invalid country calling code" == O.message && J.test(m)) {
                if (m = m.replace(J, ""), h = Ib(a, m, g, b, d, f), 0 == h) throw O;
            } else throw O;
        }
        0 != h ? (e = S(h), e != c && (g = R(a, h, e))) : (jb(e), b.a(e.toString()), null != c ? (h = w(g, 10), u(f, 1, h)) : d && Da(f, 6));
        if (2 > b.b.length) throw Error("The string supplied is too short to be a phone number");
        null !=
            g && (c = new A, e = new A(b.toString()), Jb(e, g, c), a = V(a, e.toString(), g, -1), 2 != a && 4 != a && 5 != a && (b = e, d && 0 < c.toString().length && u(f, 7, c.toString())));
        d = b.toString();
        a = d.length;
    ...
    function Pb(a) {
        for (var b = a.f.length, c = 0; c < b; ++c) {
            ...
            t.length < m.a.b.length ? m = "" : (m = t.replace(new RegExp(h, "g"), g), m = m.replace(/9/g, "\u2008"));
    ...
    function Qb(a, b) {
        for (var c = [], d = b.length - 3, e = a.f.length, f = 0; f < e; ++f) {
            var g = a.f[f];
            0 == x(g, 3) ? c.push(a.f[f]) : (g = r(g, 3, Math.min(d, x(g, 3) - 1)), 0 == b.search(g) && c.push(a.f[f]))
        }
        a.f = c
    }
    ...
    function Sb(a, b) {
        a.j.a(b);
        var c = b;
        Sa.test(c) || 1 == a.j.b.length && Ra.test(c) ? ("+" == b ? (c = b, a.o.a(b)) : (c = I[b], a.o.a(c), a.a.a(c)), b = c) : (a.l = !1, a.ka = !0);
        if (!a.l) {
            if (!a.ka)
                if (Tb(a)) {
                    if (Ub(a)) return Vb(a)
                } else if (0 < a.i.length && (b = a.a.toString(), B(a.a), a.a.a(a.i), a.a.a(b), b = a.b.toString(), c = b.lastIndexOf(a.i), B(a.b), a.b.a(b.substring(0, c))), a.i != Wb(a)) return a.b.a(" "), Vb(a);
            return a.j.toString()
        }
        switch (a.o.b.length) {
            case 0:
    ...
    function Zb(a) {
        for (var b = a.a.toString(), c = a.f.length, d = 0; d < c; ++d) {
            var e = a.f[d],
                f = w(e, 1);
            if ((new RegExp("^(?:" + f + ")$")).test(b) && (a.ca = Ob.test(r(e, 4)), e = b.replace(new RegExp(f, "g"), r(e, 2)), e = ac(a, e), M(e, Oa) == a.o)) return e
        }
        return ""
    }
    ...
    function ac(a, b) {
        var c = a.b.b.length;
        return a.ca && 0 < c && " " != a.b.toString().charAt(c - 1) ? a.b + " " + b : a.b + b
    }

    function Xb(a) {
        var b = a.a.toString();
        if (3 <= b.length) {
            for (var c = a.s && 0 == a.i.length && 0 < x(a.g, 20) ? v(a.g, 20) : v(a.g, 19), d = c.length, e = 0; e < d; ++e) {
                var f = c[e];
                0 < a.i.length && lb(w(f, 4)) && !r(f, 6) && !q(f, 5) || (0 != a.i.length || a.s || lb(w(f, 4)) || r(f, 6)) && Nb.test(w(f, 2)) && a.f.push(f)
            }
            Qb(a, b);
            b = Zb(a);
    ...
    function Wb(a) {
        ...
        d ? (c = 1, a.b.a("1").a(" "), a.s = !0) : q(a.g, 15) && (d = new RegExp("^(?:" + r(a.g, 15) + ")"), d = b.match(d), null != d && null != d[0] && 0 < d[0].length && (a.s = !0, c = d[0].length, a.b.a(b.substring(0, c))));
        B(a.a);
        a.a.a(b.substring(c));
    ...
    function Tb(a) {
        ...
        c = b.match(c);
        return null != c && null != c[0] && 0 < c[0].length ? (a.s = !0, c = c[0].length, B(a.a), a.a.a(b.substring(c)), B(a.b), a.b.a(b.substring(0, c)), "+" != b.charAt(0) && a.b.a(" "), !0) : !1
    }
    ...
    var bc = {
        ...
        NL: [,
            [, , "[1349]\\d\\d(?:\\d(?:\\d{2})?)?", , , , , , , [3, 4, 6]], , , [, , "11(?:2|6\\d{3})|911", , , , "112", , , [3, 6]],
    ...
    function kc(a, b) {
        return 0 < v(b, 9).length && !v(b, 9).includes(a.length) ? !1 : L(w(b, 2), a.toString())
    };
    var U = Na.ea();
    ...
    function nc() {
        ...
        try {
            var e = U;
            if (!mb(b) && 0 < a.length && "+" != a.charAt(0)) throw Error("Invalid country calling code");
            var f = Ab(e, a, b, !0);
            ...
            if (h)
                if (4 == m) d.a("\nisPossibleNumberWithReason(): "),
                    ...
                    d.a("\nisValidNumber(): ");
                    d.a(t);
                    t && e && (d.a("\nisValidNumberForRegion(): "), d.a(Fb(U, f, b)));
                    d.a("\nPhone Number region: ");
                    d.a(Db(U, f));
                    d.a("\ngetNumberType(): ");
                    d.a(mc(f))
            ...
            if (!t) {
                ...
                d.a("\nisValidShortNumber: ");
                d.a(lc(O, f));
                e && (d.a("\nisPossibleShortNumberForRegion: "), d.a(fc(O, f, b)), d.a("\nResult from isValidShortNumberForRegion: "), d.a(jc(O, f, b)))
            }
    ...
    for (var Z; X.length && (Z = X.shift());) X.length || void 0 === nc ? Y[Z] && Y[Z] !== Object.prototype[Z] ? Y = Y[Z] : Y = Y[Z] = {} : Y[Z] = nc;
})();
